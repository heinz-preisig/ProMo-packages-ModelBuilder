...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBoxBackup.setText(_translate("Dialog", "backup"))
        self.checkBoxInstall.setText(_translate("Dialog", "install"))
